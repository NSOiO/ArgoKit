...
extension TextView {
    ...
    public func autocapitalizationType(_ type: UITextAutocapitalizationType) -> Self {
        addAttribute(#selector(setter: UITextView.autocapitalizationType), type.rawValue)
        return self
    }
    ...
    public func autocorrectionType(_ type: UITextAutocorrectionType) -> Self{
        addAttribute(#selector(setter: UITextView.autocorrectionType), type.rawValue)
        return self
    }
    ...
    public func spellCheckingType(_ type: UITextSpellCheckingType) -> Self {
        addAttribute(#selector(setter: UITextView.spellCheckingType), type.rawValue)
        return self
    }
    ...
    public func smartQuotesType(_ type: UITextSmartQuotesType) -> Self {
        addAttribute(#selector(setter: UITextView.smartQuotesType), type.rawValue)
        return self
    }
    ...
    public func smartDashesType(_ type: UITextSmartDashesType) -> Self {
        addAttribute(#selector(setter: UITextView.smartDashesType), type.rawValue)
        return self
    }
    ...
    public func smartInsertDeleteType(_ type: UITextSmartInsertDeleteType) -> Self {
        addAttribute(#selector(setter: UITextView.smartInsertDeleteType), type.rawValue)
        return self
    }
    ...
    public func keyboardType(_ type: UIKeyboardType) -> Self {
        addAttribute(#selector(setter: UITextView.keyboardType), type.rawValue)
        return self
    }
    ...
    public func keyboardAppearance(_ type: UIKeyboardAppearance) -> Self {
        addAttribute(#selector(setter: UITextView.keyboardAppearance), type.rawValue)
        return self
    }
    ...
    public func returnKeyType(_ type: UIReturnKeyType) -> Self {
        addAttribute(#selector(setter: UITextView.returnKeyType), type.rawValue)
        return self
    }
    ...
    public func enablesReturnKeyAutomatically(_ enable: Bool) -> Self {
        addAttribute(#selector(setter: UITextView.enablesReturnKeyAutomatically), enable)
        return self
    }
    ...
    public func secureTextEntry(_ enable: Bool) -> Self {
        addAttribute(#selector(setter: UITextView.isSecureTextEntry), enable)
        return self
    }
    ...
    public func textContentType(_ type: UITextContentType) -> Self {
        addAttribute(#selector(setter: UITextView.textContentType), type.rawValue)
        return self
    }
    ...
    public func passwordRules(_ rules: UITextInputPasswordRules) -> Self {
        addAttribute(#selector(setter: UITextView.passwordRules), rules)
        return self
    }
}
