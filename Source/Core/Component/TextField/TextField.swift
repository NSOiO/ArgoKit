...
extension TextField {
    ...
    /// Set the autocapitalization style for the text object.
    /// - Parameter type: default is UITextAutocapitalizationTypeSentences
    /// - Returns: Self
    @discardableResult
    public func autocapitalizationType(_ type: UITextAutocapitalizationType) -> Self {
        addAttribute(#selector(setter: UITextField.autocapitalizationType), type.rawValue)
        return self
    }
    
    /// Set the autocorrection style for the text object.
    /// - Parameter type: default is UITextAutocorrectionTypeDefault
    /// - Returns: Self
    @discardableResult
    public func autocorrectionType(_ type: UITextAutocorrectionType) -> Self {
        addAttribute(#selector(setter: UITextField.autocorrectionType), type.rawValue)
        return self
    }
    
    /// Set the spell-checking style for the text object.
    /// - Parameter type: default is UITextSpellCheckingTypeDefault;
    /// - Returns: Self
    @discardableResult
    public func spellCheckingType(_ type: UITextSpellCheckingType) -> Self{
        addAttribute(#selector(setter: UITextField.spellCheckingType), type.rawValue)
        return self
    }
    
    /// Set the configuration state for smart quotes.
    /// - Parameter type: default is UITextSmartQuotesTypeDefault;
    /// - Returns: Self
    @available(iOS 11.0, *)
    @discardableResult
    public func smartQuotesType(_ type: UITextSmartQuotesType) -> Self {
        addAttribute(#selector(setter: UITextField.smartQuotesType), type.rawValue)
        return self
    }
    
    /// Set the configuration state for smart dashes.
    /// - Parameter type: default is UITextSmartDashesTypeDefault;
    /// - Returns: Self
    @available(iOS 11.0, *)
    @discardableResult
    public func smartDashesType(_ type: UITextSmartDashesType) -> Self {
        addAttribute(#selector(setter: UITextField.smartDashesType), type.rawValue)
        return self
    }
    
    /// Set the configuration state for the smart insertion and deletion of space characters.
    /// - Parameter type: default is UITextSmartInsertDeleteTypeDefault;
    /// - Returns: Self
    @available(iOS 11.0, *)
    @discardableResult
    public func smartInsertDeleteType(_ type: UITextSmartInsertDeleteType) -> Self {
        addAttribute(#selector(setter: UITextField.smartInsertDeleteType), type.rawValue)
        return self
    }
    
    /// Set The keyboard type for the text object.
    /// - Parameter type: default is UIKeyboardTypeDefault
    /// - Returns: Self
    @discardableResult
    public func keyboardType(_ type: UIKeyboardType) -> Self {
        addAttribute(#selector(setter: UITextField.keyboardType), type.rawValue)
        return self
    }
    
    /// Set the appearance style of the keyboard for the text object.
    /// - Parameter type: default is UIKeyboardAppearanceDefault
    /// - Returns: Self
    @discardableResult
    public func keyboardAppearance(_ type: UIKeyboardAppearance) -> Self {
        addAttribute(#selector(setter: UITextField.keyboardAppearance), type.rawValue)
        return self
    }
    
    /// Set the visible title of the Return key.
    /// - Parameter type: default is UIReturnKeyDefault (See note under UIReturnKeyType enum)
    /// - Returns: Self
    @discardableResult
    public func returnKeyType(_ type: UIReturnKeyType) -> Self {
        addAttribute(#selector(setter: UITextField.returnKeyType), type.rawValue)
        return self
    }
    
    /// Set a Boolean value that indicates whether the system automatically enables the Return key when the user is enters text.
    /// - Parameter enable: default is NO (when YES, will automatically disable return key when text widget has zero-length contents,
    ///  and will automatically enable when text widget has non-zero-length contents)
    /// - Returns: Self
    @discardableResult
    public func enablesReturnKeyAutomatically(_ enable: Bool) -> Self {
        addAttribute(#selector(setter: UITextField.enablesReturnKeyAutomatically), enable)
        return self
    }
    
    /// Set A Boolean value that indicates whether the text object disables text copying and, in some cases, hides the text that the user enters.
    /// - Parameter enable: default is NO
    /// - Returns: Self
    @discardableResult
    public func secureTextEntry(_ enable: Bool) -> Self {
        addAttribute(#selector(setter: UITextField.isSecureTextEntry), enable)
        return self
    }
    
    /// Set The semantic meaning for a text input area.
    /// - Parameter type: The textContentType property is to provide the keyboard with extra information about the semantic intent of the text document.
    /// - Returns: Self
    @available(iOS 10.0, *)
    @discardableResult
    public func textContentType(_ type: UITextContentType) -> Self {
        addAttribute(#selector(setter: UITextField.textContentType), type.rawValue)
        return self
    }
    
    /// Set requirements for passwords for your service to ensure iOS can generate compatible passwords for users.
    /// - Parameter rules: 
    /// - Returns: Self
    @available(iOS 12.0, *)
    @discardableResult
    public func passwordRules(_ rules: UITextInputPasswordRules) -> Self {
        addAttribute(#selector(setter: UITextField.passwordRules), rules)
        return self
    }
}
