...
extension Image {
    ...
    /// - Parameters:
    ///   - url: The url of a image.
    ///   - placeholderImage: The placeholder image when image is loading. You can set a image created by color as the placeholderImage.
    /// - Returns: self
    @discardableResult
    public func image(url: @escaping @autoclosure () -> URL?, placeholderImage: @escaping @autoclosure () -> UIImage?) -> Self {
        return self.bindCallback({ [self] in
    ...
    /// - Returns: self
    @discardableResult
    public func image(urlString: @escaping @autoclosure () -> String?, placeholderImage: @escaping @autoclosure () -> UIImage?) -> Self {
        return self.bindCallback({
            var url:URL? = nil
            if let urlString = urlString() {
                url = URL(string: urlString)
