...
/* 是否为根节点*/
@property (nonatomic, assign)BOOL isVirtualNode;
/* 是否为根节点*/
...
/* node包含的子节点*/
@property (nonatomic, strong, readonly,nullable)ArgoKitSafeMutableArray *childs;
//链接此node被复用到的node节点，此节点对应具体的视图
@property (nonatomic, weak,nullable)ArgoKitNode *linkNode;

//
@property (atomic, strong) ArgokitThreadSafeDictionary *bindProperties;
