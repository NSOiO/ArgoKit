...
extension View {
    ...
    /// Add the specified animation objects to the view
    /// - Parameter builder: An animation builder that creates the animations added to this view.
    /// - Returns: self
    @discardableResult
    ...
    /// Add the specified animationGroup object to this view
    /// - Parameter animationGroup: The animationGroup to be added to this view
    /// - Returns: self
    @discardableResult
    public func addAnimationGroup(_ animationGroup: AnimationGroup) -> Self {
        addAttribute(#selector(setter: UIView.argokit_animation), animationGroup)
        return self
    }
