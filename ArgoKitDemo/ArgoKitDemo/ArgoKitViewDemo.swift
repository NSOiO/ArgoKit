...
class TabSegmentDemo: ArgoKit.View {
    ...
    var body: View {
        TabSegment(["AA", "BB", "CC", "DD", "EE"]) { data in
            Text(data as? String).textAlign(.center).width(100).height(50).backgroundColor(.blue)
        }
